...
class MusicPlayer:
    ...
    def initialize_ui(self):
        ...
        self.playlist_frame.configure(bg='#000000')
        self.playlist_title.configure(bg='#000000', fg='blue')
        ...
        self.homepage_frame.configure(bg='#000000')
        self.homepage_title.configure(bg='#000000', fg='blue')
        self.library_title.configure(bg='#000000', fg='blue')
